...
| 1: Authors/README File | [AUTHORS](https://github.com/Alex-chulu/AirBnB_clone_v2/blob/dev/AUTHORS) | Project authors |
...
| 7. Console 0.0.1 | [console.py](https://github.com/justinmajetich/AirBnB_clone/blob/dev/console.py) | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D |
